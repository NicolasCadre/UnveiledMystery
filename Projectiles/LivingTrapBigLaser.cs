...
{
    public class LivingTrapBigLaser : ModProjectile
    {
        bool runOnce = false;
        NPC owner;
        ...
        {
            Asset<Texture2D> texture = Request<Texture2D>("UnveiledMystery/Projectiles/LivingTrapBigLaser");
            Asset<Texture2D> textureWarning = Request<Texture2D>("UnveiledMystery/Projectiles/LivingTrapBigLaserWarning");
    ...
    Projectile.velocity, 8.5f, Projectile.damage, -1.57f, 1f, 1000f, Color.White, (int)LASER_MAXDISTANCE);
        ...
        private void ShootProjectiles()
        {
            ...
            if (TimerShootProjectiles >= maxShoot)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), PosProjectile, Projectile.Center.Y-Projectile.height-100, 0, 0, ModContent.ProjectileType<LivingTrapProjectileFromLaserWarning>(), 0, 0f);
