...
{
    public class BossTrapDoorTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<BossTrapDoorItem>();
        }
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            NPC boss = null;
            if (Main.tile[i-1, j].TileType == ModContent.TileType<BossTrapDoorTile>())
