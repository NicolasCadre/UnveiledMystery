...
{
    public class AutomaticBoulderTrap_TileEntity : ModTileEntity
    {
        private int timer = 0;
        ...
        public override bool IsTileValidForEntity(int i, int j)
        {
            ...
            return tile.HasTile && tile.TileType == ModContent.TileType<AutomaticBoulderTrap_Tile>();
        }
        ...
        public override void Update()
        {
            ...
            if (Main.tile[Position.X, Position.Y].TileType != ModContent.TileType<AutomaticBoulderTrap_Tile>())
