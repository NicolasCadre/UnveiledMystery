...
{
    public class AutomaticDartTrapPlayerTileEntity : ModTileEntity
    {
        private int timer = 0; 
        ...
        private int[] tileTypes = new int[] { ModContent.TileType<AutomaticDartTrapPlayerTileTier1>(), ModContent.TileType<AutomaticDartTrapPlayerTileTier2>(), ModContent.TileType<AutomaticDartTrapPlayerTileTier3>(), ModContent.TileType<AutomaticDartTrapPlayerTileTier4>() };
