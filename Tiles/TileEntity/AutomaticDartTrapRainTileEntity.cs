...
{
    public class AutomaticDartTrapRainTileEntity : ModTileEntity
    {
        private int timer = 0;
        ...
        public override bool IsTileValidForEntity(int i, int j)
        {
            ...
            return tile.HasTile && tile.TileType == ModContent.TileType<AutomaticDartTrapRainTile>();
        }
        ...
        public override void Update()
        {
            ...
            if (Main.tile[Position.X, Position.Y].TileType != ModContent.TileType<AutomaticDartTrapRainTile>())
