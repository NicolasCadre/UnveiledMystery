...
{
    public class AutomaticDartTrap_TileEntity : ModTileEntity
    {
        ...
        public override bool IsTileValidForEntity(int i, int j)
        {
            ...
            return tile.HasTile && tile.TileType == ModContent.TileType<AutomaticDartTrap_Tile>();
        }
        ...
        public override void Update()
        {
            ...
            if (Main.tile[Position.X, Position.Y].TileType != ModContent.TileType<AutomaticDartTrap_Tile>())
